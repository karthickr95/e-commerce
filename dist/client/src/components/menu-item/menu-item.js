...
const MenuItemContainer = styled_components_1.default.div `
...
`;
const BackgroundImageContainer = styled_components_1.default.div `
  width: 100%;
  height: 100%;
...
const ContentContainer = styled_components_1.default.div `
  ...
  position: absolute;
`;
const ContentTitle = styled_components_1.default.span `
  font-weight: bold;
  margin-bottom: 6px;
  font-size: 22px;
  color: #4a4a4a;
`;
const ContentSubtitle = styled_components_1.default.span `
  font-weight: lighter;
  font-size: 16px;
`;
